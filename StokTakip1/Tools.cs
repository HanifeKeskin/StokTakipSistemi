...
public static void SadeceHarf(object sender, KeyPressEventArgs e)
        ...
        public static void ComboBoxHoldingGetir(ComboBox cmb)
        {
            cmb.DataSource = HoldingSirketController.HoldingleriListele();
            cmb.DisplayMember = "HoldingAdi";
            cmb.ValueMember = "HoldingId";
        }
        /// <summary>
        /// Göstereceğiniz ComboBox Kontrolüne Bölumleri Listeler
        /// </summary>
        /// <param name="cmb">Combobox Kontrolü</param>
        public static void ComboBoxBolumGetir(ComboBox cmb, int holdingId)
        {
            cmb.DataSource = HoldingSirketController.SirketleriListele(holdingId);
        ...
        {
            cmb.DataSource = KategorilerViewModel.KategorileriListele(); ;
        ...
        {
            List<StokUrunViewModel> stokListesi = StokController.StoklariGetir();
